...
<el-card class="box-card">
    ...
    <el-row>
        <el-col>
            <el-input placeholder="请输入用户名" class="input-with-select" v-model='query' clearable @clear="getAllUsers()">
    ...
    <el-table :data="tableData" style="width: 100%" height="300px">
        ...
        <el-table-column label="操作" width="200">
            <template slot-scope="scope">
                <el-button size="mini" plain type="primary" @click="showEdit(scope.row)" icon="el-icon-edit" circle></el-button>
                <el-button size="mini" plain type="danger" @click="showDele(scope.row)" icon="el-icon-delete" circle></el-button>
                <el-button size="mini" plain type="success" @click="showRoleDia(scope.row)" icon="el-icon-check" circle></el-button>
            </template>
        </el-table-column>
    </el-table>
    <!-- 分页处理 -->
